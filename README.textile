...
Note that each image's *directory name* determines with which Redmine wiki page the uploaded file will be associated. Organize accordingly.

h4. Exampe directory hierarchy
